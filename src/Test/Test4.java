...
public class Test4 {
    ...
    public static void main(String[] args)  {
        ...
        //list of only employee names by gender
        Map<String, List<String>> collect = employeeList.stream().collect(Collectors.groupingBy(Employee::getGender,
        ...
        Employee male = employeeList.stream().filter(e -> e.getGender().equalsIgnoreCase("male"))
